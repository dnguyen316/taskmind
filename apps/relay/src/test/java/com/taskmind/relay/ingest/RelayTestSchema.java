...
public final class RelayTestSchema {
    ...
    public static void create(JdbcTemplate jdbcTemplate) {
        ...
        jdbcTemplate.execute("create table analytics.task_projection (task_id uuid primary key, user_id uuid not null, project_id uuid, title varchar(500) not null, status varchar(80) not null, task_type_key varchar(80), updated_at timestamp with time zone not null)");
