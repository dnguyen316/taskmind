...
class RequestContextFilterTest {
    ...
    void createsCorrelationIdWhenAbsentAndEmitsResponseHeader()
        ...
        assertThat(response.getHeader(RequestCorrelation.HEADER_NAME)).isEqualTo(chain.correlationId);
    }
    ...
    void preservesInboundCorrelationId() throws ServletException, IOException {
        ...
        assertThat(response.getHeader(RequestCorrelation.HEADER_NAME)).isEqualTo("inbound-correlation");
    }
