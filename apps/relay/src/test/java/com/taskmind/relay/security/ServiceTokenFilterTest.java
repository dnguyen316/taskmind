...
class ServiceTokenFilterTest {
    ...
    void authenticatesBearerServiceTokenWithoutExposingCredentials() throws Exception {
        ...
        request.addHeader("Authorization", "Bearer relay-secret-token");
        ...
        FilterChain assertingChain =
                (servletRequest, servletResponse) -> {
                    ...
                    assertThat(authentication.getCredentials()).isNotEqualTo("relay-secret-token");
                };

        new RelaySecurityConfig.ServiceTokenFilter("relay-secret-token")
    ...
    @Test
    void leavesSecurityContextEmptyWhenBearerTokenDoesNotMatch() throws IOException, ServletException {
        MockHttpServletRequest request = new MockHttpServletRequest();
