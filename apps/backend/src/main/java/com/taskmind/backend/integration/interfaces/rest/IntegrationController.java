...
public class IntegrationController {
    private final IntegrationConnectionApplicationService connections; private final IntegrationProjectLinkApplicationService links; private final IntegrationImportApplicationService imports;
    public IntegrationController(IntegrationConnectionApplicationService connections, IntegrationProjectLinkApplicationService links, IntegrationImportApplicationService imports) { this.connections = connections; this.links = links; this.imports = imports; }
