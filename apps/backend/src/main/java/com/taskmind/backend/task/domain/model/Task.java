...
public record Task(
    ...
    public Task(UUID id, Long version, UUID userId, UUID projectId, String title, String description,
        ...
        this(id, version, userId, projectId, null, null, null, TaskLevel.TASK, TaskType.TASK, null, null, null,
    ...
    public Task copy(UUID parentId, TaskLevel level, TaskType type, String key, UUID assignee, Integer points,
    ...
    private static final class TaskTypeRulesBridge {
        private static void validate(TaskType type, TaskLevel level) {
