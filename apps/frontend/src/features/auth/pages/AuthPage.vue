  ...
  <main class="auth-page">
    ...
    <section class="auth-card">
      ...
      <form @submit.prevent="submit">
        ...
        <label v-if="isSignup"
          >Full name<a-input v-model:value="name" size="large" placeholder="Alex Morgan" required
            ><template #prefix><UserOutlined /></template></a-input
        ></label>
        <label
          >Email address<a-input
            v-model:value="email"
            size="large"
            type="email"
            placeholder="you@example.com"
            required
            ><template #prefix><MailOutlined /></template></a-input
        ></label>
        <label
          >Password<a-input-password
            ...
            ><template #prefix><LockOutlined /></template></a-input-password
        ></label>
