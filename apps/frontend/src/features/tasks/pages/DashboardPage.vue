...
<template>
  <AppLayout :task-count="taskMetrics.active">
      ...
      <section class="kpi-grid">
        <article class="kpi-card tm-card-surface"><h3>Active Tasks</h3><strong>{{ taskMetrics.active }}</strong><p>In progress now</p></article>
        <article class="kpi-card tm-card-surface"><h3>Due This Week</h3><strong>{{ taskMetrics.dueThisWeek }}</strong><p>Prioritize today</p></article>
        <article class="kpi-card tm-card-surface"><h3>Overdue</h3><strong>{{ taskMetrics.overdue }}</strong><p>{{ taskMetrics.overdue ? 'Needs attention' : 'All clear' }}</p></article>
        <article class="kpi-card tm-card-surface"><h3>Completed</h3><strong>{{ taskMetrics.completed }}</strong><p>Done this sprint</p></article>
      </section>
      ...
      <section class="bottom-grid">
        <div class="left-column">
          ...
          <a-card class="workload-card tm-card-surface" title="Team Workload — This Week">
            <template #extra>
          ...
          <a-card class="status-card tm-card-surface" title="Project Status">
            <template #extra><a href="#">View all</a></template>
        ...
        <div class="right-column">
          <a-card class="insights-card tm-card-surface" title="AI Insights">
          ...
          <a-card class="activity-card tm-card-surface" title="Recent Activity">
